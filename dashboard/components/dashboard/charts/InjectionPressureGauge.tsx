...
interface InjectionPressureGaugeProps {
  value: number
}
...
// Main Component
export const InjectionPressureGauge: React.FC<InjectionPressureGaugeProps> = ({ value }) => {
...
export default InjectionPressureGauge