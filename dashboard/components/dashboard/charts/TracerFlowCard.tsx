...
const getCardConfiguration = () => ({
  title: "Tracer Flow Rate",
  unit: "L/Hr",
  ranges: { min: 0.05, max: 0.3 },
  normalRange: { min: 0.1, max: 0.2 },
  description: "Critical injection parameter"
})

const renderIcon = () => (
  <div className="relative">
    <div className="absolute inset-0 bg-purple-500/20 rounded-xl blur-sm"></div>
    <div className="relative p-3 bg-gradient-to-br from-purple-500/30 to-purple-600/20 rounded-xl border border-purple-400/30 backdrop-blur-sm">
...
// Main Component
export const TracerFlowCard: React.FC<TracerFlowCardProps> = ({ value }) => {
  const config = getCardConfiguration()
