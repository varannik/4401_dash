...
interface InjectionWellTubingPressureGaugeProps {
  value: number
}
...
const getGaugeConfiguration = () => ({
  minValue: 80,
  maxValue: 200,
  normalRange: { min: 130, max: 160 },
  unit: "Bar",
  title: "Injection Well Tubing Pressure"
})
...
// Main Component
export const InjectionWellTubingPressureGauge: React.FC<InjectionWellTubingPressureGaugeProps> = ({ value }) => {
...
export default InjectionWellTubingPressureGauge